...
public class PowderToolkit implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		addPerspectiveShortcuts(layout);
		{
			...
			folderLayout.addView("uk.ac.diamond.scisoft.analysis.powder.ui.views.Loadview");
			folderLayout
					.addView("org.dawb.workbench.plotting.views.toolPageView.1D");
			folderLayout
					.addView("uk.ac.diamond.scisoft.analysis.powder.ui.views.Indexview");
			folderLayout
					.addView("uk.ac.diamond.scisoft.analysis.powder.ui.views.Compareview");
		}
		{
			IFolderLayout folderLayout = layout.createFolder("folder",
					IPageLayout.RIGHT, 0.85f, "Powder folder");
			folderLayout
					.addView("uk.ac.diamond.scisoft.analysis.powder.ui.views.LoadedDataview");
		}
		layout.addView("uk.ac.diamond.scisoft.analysis.powder.ui.views.PDPlot",
